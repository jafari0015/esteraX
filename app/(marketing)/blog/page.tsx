    ...
    <>
      ...
      <section className="bg-white text-black overflow-hidden">
        ...
        <div className="hidden md:flex justify-center items-center py-8 lg:mx-25 md:mx-18  border border-t-0 border-black border-r-0">
          <h3 className="text-black text-center md:text-2xl xl:text-4xl">Fresh stories from the world of tech and innovation.</h3>
        </div>
            ...
            {blogs.map((blog: any, index: number) => (
              ...
              >
                ...
                <div className="mt-10 text-center md:text-left">
                  <span className="text-base pt-20 pb-5 text-black">
                    {new Date(blog.publishedAt).toLocaleDateString()} • {blog.readingTime} min read
                  </span>
