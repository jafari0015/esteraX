  ...
  return (
    <>
      <section
        id={id}
        ref={ref}
        className="relative border-t-[1px] border-b-[1px] border-foreground z-10 overflow-hidden"
      >
        <h1 className="text-foreground tracking-widest uppercase absolute  md:top-14 md:-ml-4 left-5 top-5 text-xl md:-rotate-90">
          About US
        </h1>
        <div className="flex flex-col md:flex-row justify-around lg:gap-20 lg:pl-26 md:pl-12 xl:justify-between  items-center text-foreground">
